...
const struct atts_desc_ext qpps_att_db[QPPS_IDX_NB] =
{
    ...
    [QPPS_IDX_RX_DATA_VAL]         =   {{ATT_UUID_16_LEN, (uint8_t *)QPPS_RX_CHAR_UUID}, PERM(WR, ENABLE), QPP_DATA_MAX_LEN,
                                         0, NULL},
    ...
    [QPPS_IDX_VAL]                  =   {{ATT_UUID_16_LEN, (uint8_t *)QPPS_FIRST_TX_CHAR_UUID}, PERM(NTF, ENABLE), QPP_DATA_MAX_LEN,
                                         0, NULL},
...
uint8_t qpps_svc[ATT_UUID_16_LEN] = QPP_SVC_PRIVATE_UUID;// wenxue
...
/// RX data characteristic
const struct atts_char_desc qpps_char_rx_data = ATTS_CHAR(ATT_CHAR_PROP_WR_NO_RESP,
                                                          0,
                                                          QPPS_RX_CHAR_UUID);
...
//}
// wenxue
void qpps_set_service_uuid(uint8_t param[ATT_UUID_16_LEN])
{
    memcpy(qpps_svc, param, ATT_UUID_16_LEN);
}
