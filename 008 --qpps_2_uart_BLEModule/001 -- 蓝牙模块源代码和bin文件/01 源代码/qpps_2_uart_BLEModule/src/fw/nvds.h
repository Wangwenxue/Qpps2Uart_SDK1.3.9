...
enum NVDS_TAG
{
    ...
    NVDS_TAG_ADC_INT_REF_VCM            = 0x13,
		...
		// wenxue added for BLE module
		NVDS_TAG_UART_BAUD                = 0x64,  // 20160715  ID=100 
		NVDS_TAG_ADV_INTERVAL             = 0x65,  // 20160711  ID=101 
    NVDS_TAG_CONN_INTERVAL            = 0x66,  // 20160715  ID=102
    NVDS_TAG_TX_POWER                 = 0x67,  // 20160711  ID=103
